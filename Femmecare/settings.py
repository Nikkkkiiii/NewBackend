"""
Django settings for Femmecare project.
...
SECRET_KEY = 'django-insecure-o9t^_xdf(h8hg&(&@9nkp9p)&=#ft(*_o*)le+90qrwr5sv%ov'
...
WSGI_APPLICATION = 'Femmecare.wsgi.application'

ASGI_APPLICATION = 'Femmecare.asgi.application'
